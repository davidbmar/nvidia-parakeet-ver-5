...
echo ""
echo "Next Steps:"
echo "1. Setup S3 access: ./scripts/riva-059-setup-gpu-s3-readonly-access.sh"
echo "   Creates secure IAM role for S3 access (recommended for deployments)"
...
echo "3. Prepare Riva environment: ./scripts/riva-045-setup-docker-nvidia-toolkit-create-directories-for-container-deployment.sh"
echo "4. Deploy NIM container: ./scripts/riva-062-deploy-nim-from-s3-unified.sh"